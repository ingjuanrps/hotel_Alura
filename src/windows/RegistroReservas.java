...
public class RegistroReservas extends javax.swing.JFrame {
    ...
    private JComboBox cmb_equipo, cmb_pago;
    ...
    public RegistroReservas() {
        ...
        boton_login.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                System.out.println("Dia ingreso  " + dia1);
                System.out.println("Mes ingreso " + mes1);
                System.out.println("Annio ingreso " + year1);
                ...
                System.out.println("Mes 0000 " + month1);
                ...
                System.out.println("Dia salida  " + dia2);
                System.out.println("Mes salida " + mes2);
                System.out.println("Annio salida" + year2);
                ...
                System.out.println("Mes 11111  " + mes2);

                String day2 = Integer.toString(dia2);
                System.out.println("dia salida string  " + day2);

                System.out.println("mes salida string  " + month2);
                String Year2 = Integer.toString(year2);
                System.out.println("annio salida string  " + Year2);

                String fecha_IN = (Year1 + "-" + month1 + "-" + day1);
                String fecha_OUT = (Year2 + "-" + month2 + "-" + day2);

                System.out.println("FEcha entrada " + fecha_IN);
                ...
                System.out.println("Dias totales : " + NumerDay);
