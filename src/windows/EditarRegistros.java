...
public class EditarRegistros extends javax.swing.JFrame {
    ...
    private JTextField  txt_ApellidoMa, txt_Username;
    ...
    public void main(String[] args) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    EditarRegistros frame = new EditarRegistros();
    ...
    public EditarRegistros () {
        ...
        JLabel JLabel_nombreUsuario = new JLabel("EDITAR HUESPED");
        ...
        // 6 - JLabel Usuario
        JLabel JLabel_ApellidoMa = new JLabel("LLEGADA: ");
        ...
        // 6 - JLabel Usurname
        JLabel JLabel_Username = new JLabel("SALIDA: ");
        ...
        // 6 - Usuario
        JLabel JLabel_Passsword = new JLabel("COSTO: ");
